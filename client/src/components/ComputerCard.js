  ...
  return (
    <div className='bg-white w-48 h-60 relative shadow-2xl rounded-sm flex-none'>
      ...
      <div className='absolute bottom-0 p-2 rounded-lg'>
          <div className='space-y-1 mb-3' onClick={() => navigate(`/ComputerInfoCard/${computer._id}/${computer.code}/${computer.lab}/${computer.model}/${computer.brand}/${computer.processor}/${computer.memory}/${computer.disk}/${computer.graphic}/${computer.system}`)}>
